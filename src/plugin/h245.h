 ...
 * h245.h
 *
 * Header for decoding the H.245 protocol
 *
 * H.323 for Ethereal
 *
...
#ifdef USE_FOR_ETHEREAL
    void showEthereal( proto_tree *, tvbuff_t *, unsigned int ) const;
    void preShowEthereal( void );
    PString getSummary( void );
#endif  //USE_FOR_ETHEREAL
...
class H245_NonStandardMessage;
class H245_ArrayOf_DiallingInformationNumber;

class H245_DiallingInformation : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(H245_DiallingInformation, PASN_Choice);
#endif
  public:
    H245_DiallingInformation(unsigned tag = 0, TagClass tagClass = UniversalTagClass);
...
#endif
#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator H245_ArrayOf_DiallingInformationNumber &() const;
#else
    operator H245_ArrayOf_DiallingInformationNumber &();
    operator const H245_ArrayOf_DiallingInformationNumber &() const;
#endif
...
class H245_DiallingInformationNetworkType : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(H245_DiallingInformationNetworkType, PASN_Choice);
#endif
  public:
    H245_DiallingInformationNetworkType(unsigned tag = 0, TagClass tagClass = UniversalTagClass);
...
class H245_ModeElement_type : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(H245_ModeElement_type, PASN_Choice);
#endif
  public:
    H245_ModeElement_type(unsigned tag = 0, TagClass tagClass = UniversalTagClass);
...
class H245_MultilinkRequest_addConnection : public PASN_Sequence
{
  ...
  public:
    ...
    H245_SequenceNumber m_sequenceNumber;
    H245_DiallingInformation m_diallingInformation;
...
class H245_DiallingInformationNumber;

class H245_ArrayOf_DiallingInformationNumber : public PASN_Array
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(H245_ArrayOf_DiallingInformationNumber, PASN_Array);
#endif
  public:
    H245_ArrayOf_DiallingInformationNumber(unsigned tag = UniversalSet, TagClass tagClass = UniversalTagClass);

    PASN_Object * CreateObject() const;
    H245_DiallingInformationNumber & operator[](PINDEX i) const;
...
class H245_DiallingInformationNetworkType;

class H245_ArrayOf_DiallingInformationNetworkType : public PASN_Array
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(H245_ArrayOf_DiallingInformationNetworkType, PASN_Array);
#endif
  public:
    H245_ArrayOf_DiallingInformationNetworkType(unsigned tag = UniversalSet, TagClass tagClass = UniversalTagClass);

    PASN_Object * CreateObject() const;
    H245_DiallingInformationNetworkType & operator[](PINDEX i) const;
...
class H245_DiallingInformationNumber : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(H245_DiallingInformationNumber, PASN_Sequence);
#endif
  public:
    H245_DiallingInformationNumber(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);
    ...
    H245_ArrayOf_DiallingInformationNetworkType m_networkType;
