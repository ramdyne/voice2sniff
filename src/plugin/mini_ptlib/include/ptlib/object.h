 ...
 *
 * $Log: object.h,v $
 * Revision 1.1  2000/01/06 20:38:12  dliu
 * place under cvs
 *
...
class PSmartPointer : public PObject
{
  ...
  //@{
     ...
     */
    PSmartPointer(
      PSmartObject * obj = (PSmartObject *) NULL   /// Smart object to point to.
    ) { object = obj; }
...
class PNotifier : public PSmartPointer
{
  ...
  public:
    ...
    PNotifier(
      PNotifierFunction * func = (PNotifierFunction *) NULL   /// Notifier function to call.
    ) : PSmartPointer(func) { }
