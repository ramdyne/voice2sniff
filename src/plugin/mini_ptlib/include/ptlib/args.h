...
class PArgList : public PObject
{
  ...
  //@{
     ...
     */
    PArgList(
      const char * theArgPtr = (char *)NULL,   /// A string constituting the arguments
      const char * argumentSpecPtr = (char *)NULL,
  ...
  //@{
    ...
    PString GetOptionString(
      char optionChar,          /// Character letter code for the option
      const char * dflt = (char *) NULL  /// Default value of the option string
    ) const;
    /** Get option string. */
    PString GetOptionString(
      const char * optionStr,   /// String letter code for the option
